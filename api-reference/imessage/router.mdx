...
Wirebox routes Apple iMessage conversations through high-availability router phone lines. This endpoint retrieves the router phone number, pre-formatted `imessage://` URL, and a Base64-encoded QR code for user onboarding.
