...
The Wirebox REST API provides programmatic access to manage agent identities, mailboxes, messages, network tunnels, and webhooks.

For language-native ergonomics, we recommend using our official SDKs and CLI:
- **Python SDK**: [`wirebox`](https://pypi.org/project/wirebox/) (`pip install wirebox`)
- **TypeScript SDK**: [`@wirebox-sh/sdk`](https://www.npmjs.com/package/@wirebox-sh/sdk) (`npm install @wirebox-sh/sdk`)
- **Terminal CLI**: [`@wirebox-sh/cli`](https://www.npmjs.com/package/@wirebox-sh/cli) (`npm install -g @wirebox-sh/cli`)
